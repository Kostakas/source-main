            ...
            if (party != null)
            {
                ...
                if (party.Members.Count == 2)
                {
                    ...
                    if (mapConfig == null || waypoints == null || !waypoints.Regions.Any())
                    {
                        ...
                        _logger.Warning("[ TESTE ] SAINDO DA PARTY");
                        return;
                    }
                ...
                if (party.Members.Count < 2) // TESTE 2 DE MEMBRO REMOVIDO
                {
                    _logger.Information($"SISTEMA: QUANTIDADE DE MEMBROS: {party.Members.Count}");
